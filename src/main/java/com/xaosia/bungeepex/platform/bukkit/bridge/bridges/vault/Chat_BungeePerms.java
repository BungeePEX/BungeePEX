...
public class Chat_BungeePerms extends Chat
{
    ...
    private final String name = BungeePEX.getInstance().getPlugin().getPluginName();
    ...
    public class ChatServerListener implements Listener
    {
        ...
        public void onPluginDisable(PluginDisableEvent event)
        {
            ...
            if (perms != null)
            {
                ...
                if (permPlugin.getDescription().getName().equals("BungeePEX"))
                {
                    perms = null;
    ...
    {
        PermissionUser u = perms.getPermissionsManager().getUser(player);
